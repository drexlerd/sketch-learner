...
class FeatureDataFactory:
    def generate_feature_data(self, config, domain_data: DomainData, instance_datas: List[InstanceData]) -> Tuple[DomainFeatureData, List[InstanceFeatureData]]:
        ...
        subproblem_feature_datas = [self._evaluate_features(boolean_features, numerical_features, instance_data) for instance_data in instance_datas]
        return domain_feature_data, subproblem_feature_datas
