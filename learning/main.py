...
if __name__ == "__main__":
    ...
    parser.add_argument("--disable_closed_Q", action='store_true', help="Whether the search space is closed. Default is True.")
    ...
    parser.add_argument("--enable_goal_separating_features", action='store_true', help="Whether to enable goal separating features. Default is True.")
    parser.add_argument("--disable_feature_generation", action='store_true', help="Whether to enable feature generation. Default is True.")
