...
if __name__ == "__main__":
    ...
    parser.add_argument("--concept_complexity_limit", type=int, default=8, help="The complexity limit for concepts.")
    parser.add_argument("--role_complexity_limit", type=int, default=8, help="The complexity limit for roles.")
    parser.add_argument("--boolean_complexity_limit", type=int, default=8, help="The complexity limit for boolean features.")
    parser.add_argument("--count_numerical_complexity_limit", type=int, default=8, help="The complexity limit for count numerical features.")
    parser.add_argument("--distance_numerical_complexity_limit", type=int, default=8, help="The complexity limit for distance numerical features.")
