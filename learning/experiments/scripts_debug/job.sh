...
python3 ${SKETCH_LEARNER_DIR}/learning/experiments/scripts_debug/${DOMAIN_NAME}.py --domain_filepath ${DOMAIN} --problems_directory ${PROBLEMS} --workspace ${WORKSPACE} --width ${WIDTH} 2> ${RUN_ERR} 1> ${RUN_LOG}
