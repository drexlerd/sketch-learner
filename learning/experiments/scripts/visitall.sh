...
DOMAIN="${PWD}/../../benchmarks/visitall/domain.pddl"
TASK_DIR="${PWD}/../../benchmarks/visitall/instances"
WIDTH=$1
...
WORKSPACE="${PWD}/workspace/visitall_${WIDTH}_${CONCEPT_COMPLEXITY}_${ROLE_COMPLEXITY}_${BOOLEAN_COMPLEXITY}_${COUNT_NUMERICAL_COMPLEXITY}_${DISTANCE_NUMERICAL_COMPLEXITY}"
