...
DOMAIN="${PWD}/../../benchmarks/delivery/domain.pddl"
TASK_DIR="${PWD}/../../benchmarks/delivery/instances"
WIDTH=$1
...
WORKSPACE="${PWD}/workspace/delivery_${WIDTH}_${CONCEPT_COMPLEXITY}_${ROLE_COMPLEXITY}_${BOOLEAN_COMPLEXITY}_${COUNT_NUMERICAL_COMPLEXITY}_${DISTANCE_NUMERICAL_COMPLEXITY}"
