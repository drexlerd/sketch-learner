...
public:
	...
	// Dominik: added index 0 to initial state
	...
	// Dominik: index of new state must be passed as argument.
	virtual State*	next( const State& s, Action_Idx a, int index ) const = 0;
