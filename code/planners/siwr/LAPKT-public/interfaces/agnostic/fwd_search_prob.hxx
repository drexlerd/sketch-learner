...
public:
	...
	virtual float		cost( const State& s, Action_Idx a ) const;
        virtual State*		next( const State& s, Action_Idx a, Fluent_Vec* added, Fluent_Vec* deleted, int index=-1 ) const;
    virtual State*		next( const State& s, Action_Idx a, int index=-1 ) const;
