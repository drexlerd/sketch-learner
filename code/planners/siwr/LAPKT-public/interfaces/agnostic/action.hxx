...
public:
	...
	phmap::flat_hash_set<unsigned>&	           	prec_set() { return m_prec_set; }
	Fluent_Vec&	           	add_vec()  { return m_add_vec; }
	phmap::flat_hash_set<unsigned>&	           	add_set()  { return m_add_set; }
	Fluent_Vec&	           	del_vec()  { return m_del_vec; }
	phmap::flat_hash_set<unsigned>&	           	del_set()  { return m_del_set; }
	Fluent_Vec&	           	edel_vec()  { return m_edel_vec; }
	phmap::flat_hash_set<unsigned>&	           	edel_set()  { return m_edel_set; }
	Conditional_Effect_Vec&    	ceff_vec(){ return m_cond_effects; }

	const Fluent_Vec&		prec_vec() const { return m_prec_vec; }
	const phmap::flat_hash_set<unsigned>&	        prec_set() const { return m_prec_set; }
	const Fluent_Vec&	        add_vec()  const { return m_add_vec; }
	const phmap::flat_hash_set<unsigned>&	        add_set()  const { return m_add_set; }
	const Fluent_Vec&	        del_vec()  const { return m_del_vec; }
	const phmap::flat_hash_set<unsigned>&	        del_set()  const { return m_del_set; }
	const Fluent_Vec&	        edel_vec()  const { return m_edel_vec; }
	const phmap::flat_hash_set<unsigned>&	        edel_set()  const { return m_edel_set; }
	...
	void		           	define_fluent_list( const Fluent_Vec& in, Fluent_Vec& list, phmap::flat_hash_set<unsigned>& set );
...
protected:
	...
	phmap::flat_hash_set<unsigned>			m_prec_set;
	Fluent_Vec			m_add_vec;
	phmap::flat_hash_set<unsigned>			m_add_set;
	Fluent_Vec			m_del_vec;
	phmap::flat_hash_set<unsigned>			m_del_set;
	Fluent_Vec			m_edel_vec;
	phmap::flat_hash_set<unsigned>			m_edel_set;
