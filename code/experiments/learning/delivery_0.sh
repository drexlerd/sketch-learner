...
${D2L_PATH}/experiments/run.py ${DOMAIN}:${EXPERIMENT} -w ${WIDTH} -r ${MAX_SKETCH_RULES} -c ${COMPLEXITY} > "${D2L_PATH}/workspace/${EXPERIMENT_NAME}/run.log"
