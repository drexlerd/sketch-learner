...
protected:
	...
	std::vector<int> m_fluent_to_dlplan_indices;
...
public:
	 ...
	 */
	dlplan::core::State from_lapkt_state(State* state) const;

	dlplan::core::State get_default_state() const;

    dlplan::core::InstanceInfo& get_instance_info() { return *m_instance_info; }
